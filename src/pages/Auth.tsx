      ...
      <div className="flex-1 flex flex-col justify-center px-6 max-w-md mx-auto w-full">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <Button
            type="button"
            variant="outline"
            className="h-12 bg-card border-border/60 w-full opacity-70"
            disabled
            title="Apple sign-in is disabled until Apple + Supabase Auth are configured (see signInWithApplePlaceholder in src/lib/auth.ts)."
          >
