    ...
    <div className="min-h-screen bg-gradient-dawn flex flex-col">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 max-w-md mx-auto w-full">
        <div className="text-center mb-8 animate-fade-in">
          ...
          <h1 className="font-serif text-4xl mt-3">{mode === "signin" ? "Welcome back" : "Begin your journey"}</h1>
          <p className="text-muted-foreground text-sm mt-2">
            {mode === "signin" ? "Continue your sacred search" : "Create your spiritual profile"}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 animate-fade-in">
          {mode === "signup" && (
            <div className="space-y-2">
              ...
              />
=======
        <form onSubmit={(e) => { e.preventDefault(); nav(method === "phone" ? "/auth/otp" : "/onboarding"); }} className="space-y-4 animate-fade-in">
          {mode === "signup" && (
            <div className="space-y-2">
              <Label>Full name</Label>
              <Input placeholder="Your beautiful name" className="h-12 bg-card border-border/60" />
>>>>>>> da101e9a528a6a7e757745cde99a6b6840993682
            </div>
          )}
          <div className="space-y-2">
            <Label>{method === "email" ? "Email" : "Phone number"}</Label>
            <Input
<<<<<<< HEAD
              value={emailOrPhone}
...
>>>>>>> da101e9a528a6a7e757745cde99a6b6840993682
              ...
              placeholder={method === "email" ? "you@soul.com" : "+91 98765 43210"}
              className="h-12 bg-card border-border/60"
            />
          </div>
          {method === "email" && (
...
<<<<<<< HEAD
          ...
          >
=======
              <Input type="password" placeholder="••••••••" className="h-12 bg-card border-border/60" />
            </div>
          )}
          <Button type="submit" className="w-full h-12 bg-gradient-saffron text-primary-foreground shadow-warm font-medium">
>>>>>>> da101e9a528a6a7e757745cde99a6b6840993682
            {method === "phone" ? "Send OTP" : mode === "signin" ? "Sign in" : "Create account"}
          </Button>
        </form>
...
<<<<<<< HEAD
          <Button
            variant="outline"
            className="h-12 bg-card border-border/60 hover:bg-secondary"
            onClick={() => void handleGoogleSignIn()}
            disabled={isSubmitting}
          >
=======
          <Button variant="outline" className="h-12 bg-card border-border/60 hover:bg-secondary">
>>>>>>> da101e9a528a6a7e757745cde99a6b6840993682
        ...
        <p className="text-center text-sm text-muted-foreground mt-8">
          {mode === "signin" ? "New to AatmamIlan? " : "Already have an account? "}
