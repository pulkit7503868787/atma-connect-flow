    ...
    <div className="min-h-screen bg-gradient-dawn flex flex-col">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 max-w-md mx-auto w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <Button
            variant="outline"
            className="h-12 min-h-[3rem] px-3 bg-card border-border/60 hover:bg-secondary w-full text-sm leading-tight whitespace-normal text-center justify-center"
          ...
          <Button
            type="button"
            variant="outline"
            className="h-12 min-h-[3rem] px-3 bg-card border-border/60 hover:bg-secondary w-full text-sm"
            onClick={() => void handleAppleSignIn()}
            disabled={isSubmitting}
          >
            <svg className="h-4 w-4 mr-2 shrink-0" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
        ...
        <p className="text-center text-[11px] text-muted-foreground mt-4 leading-relaxed px-2">
          Teachers shown in onboarding honour many lineages — walk with the guide who feels like home.
        </p>
